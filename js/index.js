...
function getData(){
    ...
    if (isNaN(n)) {document.getElementById("answercyc").innerHTML = 'Помилка - введіть число';}
    else {
function fib(n) {
    let answer;
    let a = 1, b = 1;
...
function getDataRec() {
    ...
    if (isNaN(m)) {document.getElementById("answerrec").innerHTML = 'Помилка - введіть число';}
    else {
function fibrec(m) { 
   if (m <= 2){return 1;}
